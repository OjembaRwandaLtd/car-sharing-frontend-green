...
const Button = ({ value, type = "default", width = "default", handleClick }: ButtonProp): ReactElement => {
  ...
  const buttonTypeStyle = {
    ...
    outline: "btn-outline hover:bg-transparent hover:border-white hover:text-white border-2 border-white text-white",
